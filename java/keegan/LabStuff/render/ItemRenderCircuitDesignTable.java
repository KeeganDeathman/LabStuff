...
public class ItemRenderCircuitDesignTable implements IItemRenderer {

	protected ModelCircuitDesignTable tableModel;
	protected ResourceLocation Tex;
	
	
	public ItemRenderCircuitDesignTable()
	{
		tableModel = new ModelCircuitDesignTable();
		Tex = new ResourceLocation("labstuff:textures/models/CircuitDesignTable.png");
	}
	...
	private void renderEquipped(boolean inventory, ItemRenderType type,  Object... data)
    {
        ...
        if(inventory)
        {
        	...
        	tableModel.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.03125F);
        }
        else if(!inventory)
        {
    		Minecraft.getMinecraft().renderEngine.bindTexture(Tex);
        	tableModel.render((Entity) data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.03125F);
        }
