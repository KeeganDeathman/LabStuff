...
public class ContainerFermenter extends Container {
	...
	private Fermenter tileEntity;
	
	public ContainerFermenter(InventoryPlayer invPlayer, Fermenter te)
	{
		tileEntity = te;
		
		this.addSlotToContainer(new SlotInput(te, 0, 75, 170));
		this.addSlotToContainer(new SlotOutput(te, 1, 132, 170));
