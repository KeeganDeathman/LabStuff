...
public class ContainerKeyPunch extends Container
{
	
	private KeyPunch tile;
	private EntityPlayer player;

	public ContainerKeyPunch(InventoryPlayer inv, KeyPunch tile)
	{
		this.tile = tile;
		...
		this.addSlotToContainer(new Slot(tile, 0, 116, 216));
