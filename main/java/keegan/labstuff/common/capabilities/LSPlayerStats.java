...
public abstract class LSPlayerStats
{
    public static LSPlayerStats get(Entity entity)
    {
        return entity.getCapability(Capabilities.LS_STATS_CAPABILITY, null);
    }
    ...
    public abstract void copyFrom(LSPlayerStats oldData, boolean keepInv);
