...
public class BlockLandingPad extends BlockAdvancedTile implements IPartialSealableBlock, IShiftDescription, ISortableBlock
{
    ...
    {
        final Block id = LabStuffMain.landingPad;
        ...
        if (worldIn.getBlockState(pos.offset(EnumFacing.DOWN)).getBlock() == LabStuffMain.landingPad && side == EnumFacing.UP)
        {
            return false;
        }
        else
    ...
    public String getShiftDescription(int meta)
    {
        ...
        return LabStuffUtils.translate("tile.buggy_pad.description");
    }
