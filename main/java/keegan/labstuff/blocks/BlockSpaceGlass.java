...
public class BlockSpaceGlass extends Block implements IPartialSealableBlock, IShiftDescription, ISortableBlock
{
    ...
    public BlockSpaceGlass(String assetName, GlassType newType, GlassFrame newFrame, Block base)
    {
        ...
        this.isClient = LabStuffMain.proxy.getClass().getName().equals("keegan.labstuff.client.LabStuffClientProxy");
        this.type = newType;
        this.frame = newFrame;
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int damage, EntityLivingBase placer)
    {
        ...
        case TIN_DECO:
        {
            ...
            {
            case STRONG:
                return LabStuffMain.spaceGlassTinStrong.getDefaultState();
            case VANILLA:
                return LabStuffMain.spaceGlassTinVanilla.getDefaultState();
            default:
                return LabStuffMain.spaceGlassTinClear.getDefaultState();
            }
        }
        case PLAIN:
        default:
...
//        }
    ...
    public String getShiftDescription(int meta)
    {
        ...
        {
        case CLEAR:
            return LabStuffUtils.translate("tile.space_glass.clear.description");
        case VANILLA:
            return LabStuffUtils.translate("tile.space_glass.description");
        case STRONG:
        default:
            return LabStuffUtils.translate("tile.space_glass.strong.description");
        }
