...
import keegan.labstuff.blocks.BlockBasicMars;
...
{
    public static final IBlockState BLOCK_FILL = LabStuffMain.marsBlock.getDefaultState().withProperty(BlockBasicMars.BASIC_TYPE, BlockBasicMars.EnumBlockBasic.MARS_STONE);

    private final BiomeDecoratorMars biomeDecoratorMars = new BiomeDecoratorMars();
    private Random rand;
    ...
    public ChunkProviderMars(World worldIn, long seed, boolean mapFeaturesEnabled)
    {
    ...
    public Chunk provideChunk(int x, int z)
    {
        ...
        this.cavernGenerator.generate(this.worldObj, x, z, chunkprimer);
