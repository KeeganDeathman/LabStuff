                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D)
                                        {
                                            ...
                                            if (toReplace.getBlock() == LabStuffMain.venusBlock)
                                            {
                                                ...
                                                if (type == BlockBasicVenus.EnumBlockBasicVenus.ROCK_HARD || type == BlockBasicVenus.EnumBlockBasicVenus.ROCK_SOFT)
                                                {
                                                    ...
                                                    {
                                                        primer.setBlockState(localX, localY, localZ, LabStuffMain.venusBlock.getDefaultState().withProperty(BlockBasicVenus.BASIC_TYPE_VENUS, BlockBasicVenus.EnumBlockBasicVenus.ROCK_MAGMA));
                                                    }
                                                    else
                                                    {
