...
public abstract class GenLayerLSMap extends net.minecraft.world.gen.layer.GenLayer
{
    /** seed from World#getWorldSeed that is used in the LCG prng */
    private long worldGenSeed;
    /** parent GenLayer that was provided via the constructor */
    protected GenLayerLSMap parent;
    /**
    ...
    public static GenLayerLSMap[] initializeAllBiomeGenerators(long seed, WorldType p_180781_2_, String p_180781_3_)
    {
        GenLayerLSMap genlayer = new GenLayerIsland(1L);
        ...
        GenLayerLSMap genlayer4 = GenLayerZoom.magnify(1000L, genlayerdeepocean, 0);
        ...
        GenLayerLSMap lvt_8_1_ = GenLayerZoom.magnify(1000L, genlayer4, 0);
        GenLayerRiverInit genlayerriverinit = new GenLayerRiverInit(100L, lvt_8_1_);
        GenLayerLSMap lvt_10_1_ = GenLayerZoom.magnify(1000L, genlayerriverinit, 2);
        GenLayerLSMap genlayerbiomeedge = worldType_getBiomeLayer(seed, genlayer4, p_180781_3_, p_180781_2_);
        GenLayerLSMap genlayerhills = new GenLayerHills(1000L, genlayerbiomeedge, lvt_10_1_);
        GenLayerLSMap genlayer5 = GenLayerZoom.magnify(1000L, genlayerriverinit, 2);
        ...
        GenLayerLSMap genlayer3 = new GenLayerVoronoiZoom(10L, genlayerrivermix);
        genlayerrivermix.initWorldGenSeed(seed);
        genlayer3.initWorldGenSeed(seed);
        return new GenLayerLSMap[] {genlayerrivermix, genlayer3, genlayerrivermix};
    }

    private static GenLayerLSMap worldType_getBiomeLayer(long seed, GenLayerLSMap parentLayer, String chunkProviderSettingsJson, WorldType worldType)
    {
    	GenLayerLSMap ret = new GenLayerBiome(200L, parentLayer, worldType, chunkProviderSettingsJson);
    	ret = GenLayerZoom.magnify(1000L, ret, 2);
    	ret = new GenLayerBiomeEdge(1000L, ret);
    	return ret;
	}

	public GenLayerLSMap(long p_i2125_1_)
    {
        super(p_i2125_1_);
