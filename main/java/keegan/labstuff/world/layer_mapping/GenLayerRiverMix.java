...
public class GenLayerRiverMix extends GenLayerLSMap
{
    private GenLayerLSMap biomePatternGeneratorChain;
    private GenLayerLSMap riverPatternGeneratorChain;

    public GenLayerRiverMix(long p_i2129_1_, GenLayerLSMap p_i2129_3_, GenLayerLSMap p_i2129_4_)
    {
        super(p_i2129_1_);
