...
public class GenLayerBiome extends GenLayerLSMap
{
    ...
    public GenLayerBiome(long p_i45560_1_, GenLayerLSMap p_i45560_3_, WorldType p_i45560_4_, String p_i45560_5_)
    {
        super(p_i45560_1_);
