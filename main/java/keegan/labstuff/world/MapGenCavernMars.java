                                ...
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        if (var51 > -0.7D)
                                        {
                                            ...
                                            if (block == LabStuffMain.marsBlock || block == LabStuffMain.blockSludge || block == LabStuffMain.vine)
                                            {
                                ...
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        if (var51 > -0.7D)
                                        {
                                            ...
                                            if (Blocks.AIR == block)
                                            {
                                                if (blockAbove == LabStuffMain.marsBlock && this.rand.nextInt(200) == 0)
                                                {
                                                    int modifier = 0;

                                                    while (Blocks.AIR == block && var50 + modifier > 0)
                                                    {
                                                        primer.setBlockState(var42, var50 + modifier, var45, LabStuffMain.vine.getStateFromMeta(Math.abs(modifier) % 3));
//                                                        arrayOfIDs[coordsBelow] = LabStuffMain.vine;
//                                                        arrayOfMeta[coordsBelow] = (byte) (Math.abs(modifier) % 3);
                                                        modifier--;
                                                        block = primer.getBlockState(var42, var50 + modifier, var45).getBlock();
                                                    }
                                                }
                                                else if (blockBelow == LabStuffMain.marsBlock && this.rand.nextInt(200) == 0)
                                                {
                                                    primer.setBlockState(var42, var50, var45, LabStuffMain.blockSludge.getStateFromMeta(0));
//                                                    arrayOfIDs[coords] = LabStuffMain.blockSludge;
