...
public class SpaceStationWorldData extends WorldSavedData
{
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        {
            LSLog.info("Home planet data not found in space station save file for \"" + this.spaceStationName + "\". Using default overworld.");
        ...
        {
            LSLog.info("Static dimension ID not found in space station save file for \"" + this.spaceStationName + "\". Using default overworld.");
        ...
        {
            LSLog.info("Dynamic dimension ID not found in space station save file for \"" + this.spaceStationName + "\". Using default overworld.");
    ...
    public static SpaceStationWorldData getMPSpaceStationData(World var0, int var1, EntityPlayer player)
    {
        ...
        if (var0 == null)
        {
            var0 = DimensionManager.getWorld(0);
        }
    ...
    public static void updateSSOwnership(EntityPlayerMP player, String playerName, LSPlayerStats stats, int stationID, SpaceStationWorldData stationData)
    {
        if (stationData == null)
        {
        ...
        if (stationData.owner.equals(playerName))
        {
            ...
            {
                LSLog.debug("Player owns station: " + stationData.getSpaceStationName() + " with home planet " + stationData.getHomePlanet());
        ...
        else
        {
            ...
            {
                LSLog.debug("Player does not own station: " + stationData.getSpaceStationName() + " with home planet " + stationData.getHomePlanet());
                stats.getSpaceStationDimensionData().remove(savedOwned);
            }
        }
    }

    public static void checkAllStations(EntityPlayerMP thePlayer, LSPlayerStats stats)
    {
