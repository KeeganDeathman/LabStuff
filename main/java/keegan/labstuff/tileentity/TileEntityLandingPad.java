...
//    }
    ...
    public void onCreate(World world, BlockPos placedPosition)
    {
        ...
        ((BlockMulti) LabStuffMain.fakeBlock).makeFakeBlock(world, positions, placedPosition, EnumBlockMultiType.ROCKET_PAD);
    }
    ...
    public void onDestroy(TileEntity callingBlock)
    {
        ...
        for (BlockPos pos : positions)
        {
            ...
            if (stateAt.getBlock() == LabStuffMain.fakeBlock && (EnumBlockMultiType) stateAt.getValue(BlockMulti.MULTI_TYPE) == EnumBlockMultiType.ROCKET_PAD)
            {
