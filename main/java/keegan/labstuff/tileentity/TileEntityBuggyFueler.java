...
public class TileEntityBuggyFueler extends TileEntityMulti implements IMultiBlock, IFuelable, IFuelDock, ICargoEntity
{
    ...
    public void onCreate(World world, BlockPos placedPosition)
    {
        ...
        ((BlockMulti) LabStuffMain.fakeBlock).makeFakeBlock(world, positions, placedPosition, EnumBlockMultiType.BUGGY_FUEL_PAD);
    }
    ...
    public void onDestroy(TileEntity callingBlock)
    {
        ...
        for (BlockPos pos : positions)
        {
            ...
            if (stateAt.getBlock() == LabStuffMain.fakeBlock && (EnumBlockMultiType) stateAt.getValue(BlockMulti.MULTI_TYPE) == EnumBlockMultiType.BUGGY_FUEL_PAD)
            {
