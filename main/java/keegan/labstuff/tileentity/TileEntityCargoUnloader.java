...
import keegan.labstuff.blocks.BlockCargoLoader;
...
public class TileEntityCargoUnloader extends TileEntityAdvanced implements IEnergyWrapper, ILandingPadAttachable
{
...
//    }
    ...
    {
        return LabStuffUtils.translate("container.cargounloader.name");
    }
