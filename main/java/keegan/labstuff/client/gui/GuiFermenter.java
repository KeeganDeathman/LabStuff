...
import keegan.labstuff.container.ContainerFermenter;
...
{
	private Fermenter tile;
	private EntityPlayer player;
	private ResourceLocation Tex = new ResourceLocation("labstuff:textures/gui/squeezer.png");


	public GuiFermenter(InventoryPlayer inventory, Fermenter tileEntity)
	{
		super(new ContainerFermenter(inventory, tileEntity));
