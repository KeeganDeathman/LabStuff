...
public class GuiTextArea extends Gui
{
    ...
    public GuiTextArea(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextArea()
    {
        if (this.getVisible())
        {
            ...
            if (!s.isEmpty())
            {
                ...
                this.fontRendererInstance.drawSplitString(s1, l, i1, this.width, i);
            }
