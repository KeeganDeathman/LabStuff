...
import keegan.labstuff.container.ContainerChloralakizer;
import keegan.labstuff.render.LabStuffRenderer;
import keegan.labstuff.render.LabStuffRenderer.FluidType;
import keegan.labstuff.tileentity.Chloralakizer;
import net.minecraft.client.gui.inventory.GuiContainer;
import net.minecraft.entity.player.*;
import net.minecraft.util.ResourceLocation;
import net.minecraftforge.fluids.FluidStack;

public class GuiChloralakizer extends GuiContainer
{
	private Chloralakizer tile;
	private EntityPlayer player;
	private ResourceLocation Tex = new ResourceLocation("labstuff:textures/gui/Chloralakizer.png");


	public GuiChloralakizer(InventoryPlayer inventory, Chloralakizer tileEntity)
	{
		super(new ContainerChloralakizer(inventory, tileEntity));
	...
	protected void drawGuiContainerForegroundLayer(int arg0, int arg1)
	{
		...
		this.fontRendererObj.drawString("Water: " + (tile.getTankInfo(null)[0].fluid != null ? tile.getTankInfo(null)[0].fluid.amount : 0) + "/10000", 10, 120, 4210752);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	{
		...
		{
			displayGauge(16, 121, tile.getScaledFluidLevel(100), tile.getTankInfo(null)[0].fluid);
		}
	}
