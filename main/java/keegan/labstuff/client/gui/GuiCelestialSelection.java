...
import keegan.labstuff.world.SpaceStationType;
...
public class GuiCelestialSelection extends GuiScreen
{
    ...
    public static ResourceLocation guiMain0 = new ResourceLocation("labstuff:textures/gui/celestialselection.png");
    public static ResourceLocation guiMain1 = new ResourceLocation("labstuff:textures/gui/celestialselection.png");
    ...
    protected Object selectedParent = LabStuffMain.solarSystemSol;
...
//                        this.timeBackspacePressed = System.currentTimeMillis();
    ...
    protected boolean canCreateSpaceStation(CelestialBody atBody)
    {
        ...
        if (!LabStuffClientProxy.clientSpaceStationID.containsKey(atBody.getDimensionID()))
        {
            return true;
        }

        int resultID = LabStuffClientProxy.clientSpaceStationID.get(atBody.getDimensionID());

        if (resultID != 0 && resultID != -1)
//        if (LabStuffClientProxy.clientSpaceStationID != 0 && LabStuffClientProxy.clientSpaceStationID != -1)
        {
            return false;
        }
            ...
            if (this.selectedBody.getReachable() && this.possibleBodies != null && this.possibleBodies.contains(this.selectedBody))
            {
                try
                {
                    ...
                    if (this.selectedBody instanceof Satellite)
                    {
                        ...
                        {
                            LSLog.severe("Please report as a BUG: spaceStationIDs was null.");
                            return false;
                        }
                        ...
                        if (mapping == null)
                        {
                            LSLog.severe("Problem matching player name in space station check: " + this.selectedStationOwner);
                            return false;
                        }
                        ...
                        {
                            LSLog.severe("Failed to find a spacestation with dimension " + spacestationID);
                            return false;
                        }
                    }
                    else
                    ...
                    LabStuffMain.packetPipeline.sendToServer(new PacketSimple(PacketSimple.EnumSimplePacket.S_TELEPORT_ENTITY, LabStuffUtils.getDimensionID(mc.theWorld), new Object[] { dimension }));
            ...
            if (x > width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 96 && x < width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE && y > GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 182 && y < GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 182 + 12)
            {
                if (this.selectedBody != null)
                {
                    ...
                    if (recipe != null && this.canCreateSpaceStation(this.selectedBody))
                    {
                        ...
                        {
                            LabStuffMain.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_BIND_SPACE_STATION_ID, LabStuffUtils.getDimensionID(this.mc.theWorld), new Object[] { this.selectedBody.getDimensionID() }));
...
//	                    	this.spaceStationNames.put(strName, this.renamingString);
                            LabStuffMain.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_RENAME_SPACE_STATION, LabStuffUtils.getDimensionID(this.mc.theWorld), new Object[] { this.renamingString, spacestationID }));
                        }
        ...
        {
            selectedParent = LabStuffMain.solarSystemSol;
        }
    ...
    public void drawButtons(int mousePosX, int mousePosY)
    {
        ...
        if (this.selectionState == EnumSelectionState.PROFILE)
        {
            ...
            String str = LabStuffUtils.translate("gui.message.catalog.name").toUpperCase();
            ...
            if (this.selectedBody != null)
            {
                ...
                str = LabStuffUtils.translate("gui.message.back.name").toUpperCase();
...
//			this.drawRectD(posX2 + 16.5, menuTopLeft + 13, posX + 131, menuTopLeft + 14, LabStuffUtils.to32BitColor(120, 0, (int) (0.6F * 255), 255));
            }
        }
        else
        {
            ...
            str = LabStuffUtils.translate("gui.message.catalog.name").toUpperCase();
            ...
            if (this.mapMode)
            {
                ...
                str = LabStuffUtils.translate("gui.message.exit.name").toUpperCase();
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            if (this.selectedBody != null)
            {
                ...
                if (this.selectedBody instanceof Satellite)
                {
                    ...
                    {
                        str = LabStuffUtils.translate("gui.message.select_ss.name");
                    ...
                    {
                        str = LabStuffUtils.translate("gui.message.ss_owner.name");
                ...
                if (this.canCreateSpaceStation(this.selectedBody) && (!(this.selectedBody instanceof Satellite)))
                {
                    GL11.glColor4f(0.0F, 0.6F, 1.0F, 1);
                    this.mc.renderEngine.bindTexture(GuiCelestialSelection.guiMain1);
                    int canCreateLength = Math.max(0, this.drawSplitString(LabStuffUtils.translate("gui.message.can_create_space_station.name"), 0, 0, 91, 0, true, true) - 2);
                    ...
                    if (recipe != null)
                    {
                        ...
                        this.drawSplitString(LabStuffUtils.translate("gui.message.can_create_space_station.name"), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 48, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 137, 91, ColorUtil.to32BitColor(255, color, 255, color), true, false);

                        if (!mapMode)
                        {
                            this.drawSplitString(LabStuffUtils.translate("gui.message.create_ss.name").toUpperCase(), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 48, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 185 + canCreateOffset, 91, ColorUtil.to32BitColor(255, 255, 255, 255), false, false);
                        }
                    }
                    else
                    {
                        this.drawSplitString(LabStuffUtils.translate("gui.message.cannot_create_space_station.name"), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 48, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 138, 91, ColorUtil.to32BitColor(255, 255, 255, 255), true, false);
                    }
                }
                ...
                if (this.selectedBody.getTierRequirement() >= 0 && (!(this.selectedBody instanceof Satellite)))
                {
                    ...
                    str = LabStuffUtils.translateWithFormat("gui.message.tier.name", this.selectedBody.getTierRequirement() == 0 ? "?" : this.selectedBody.getTierRequirement());
                ...
                if (this.selectedBody instanceof Satellite)
                {
                    str = LabStuffUtils.translate("gui.message.rename.name").toUpperCase();
                }
                ...
                if (!this.mapMode)
                {
                    ...
                    this.mc.renderEngine.bindTexture(GuiCelestialSelection.guiMain0);
                    this.drawTexturedModalRect(width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 74, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE, 74, 11, 0, 392, 148, 22, true, false);
                    str = LabStuffUtils.translate("gui.message.launch.name").toUpperCase();
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                ...
                if (this.selectionCount == 1 && !(this.selectedBody instanceof Satellite))
                {
                    ...
                    if (flag0 && flag1)
                    {
                        this.drawSplitString(LabStuffUtils.translate("gui.message.click_again.0.name"), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 182 + 41, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 1 - 38 + sliderPos, 79, ColorUtil.to32BitColor(255, 150, 150, 150), false, false);
                    }
                    else if (!flag0 && flag1)
                    {
                        this.drawSplitString(LabStuffUtils.translate("gui.message.click_again.1.name"), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 182 + 41, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 5 - 38 + sliderPos, 79, ColorUtil.to32BitColor(255, 150, 150, 150), false, false);
                    }
                    else if (flag0)
                    {
                        this.drawSplitString(LabStuffUtils.translate("gui.message.click_again.2.name"), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 182 + 41, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 5 - 38 + sliderPos, 79, ColorUtil.to32BitColor(255, 150, 150, 150), false, false);
                    }
                    else
                    {
                        this.drawSplitString(LabStuffUtils.translate("gui.message.click_again.3.name"), width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE - 182 + 41, GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE + 10 - 38 + sliderPos, 79, ColorUtil.to32BitColor(255, 150, 150, 150), false, false);
                    }
                ...
                if (this.selectedBody instanceof Satellite && renamingSpaceStation)
                {
                    ...
                    str = LabStuffUtils.translate("gui.message.assign_name.name");
                    ...
                    str = LabStuffUtils.translate("gui.message.apply.name");
                    ...
                    str = LabStuffUtils.translate("gui.message.cancel.name");
