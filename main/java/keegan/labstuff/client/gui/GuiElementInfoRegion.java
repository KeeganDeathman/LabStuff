...
import keegan.labstuff.util.ColorUtil;
...
public class GuiElementInfoRegion extends Gui
{
    ...
    public GuiContainerLS parentGui;

    public GuiElementInfoRegion(int xPos, int yPos, int width, int height, List<String> tooltipStrings, int parentWidth, int parentHeight, GuiContainerLS parentGui)
    {
        this.width = 200;
        this.height = 20;
        this.enabled = true;
