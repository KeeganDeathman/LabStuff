...
public class OverlayDockingRocket extends Overlay
{
    ...
    public static void renderDockingOverlay()
    {
        ...
        final ScaledResolution scaledresolution = LabStuffUtils.getScaledRes(OverlayDockingRocket.minecraft, OverlayDockingRocket.minecraft.displayWidth, OverlayDockingRocket.minecraft.displayHeight);
        ...
        if (OverlayDockingRocket.minecraft.thePlayer.getRidingEntity() instanceof EntityAutoRocket)
        {
            ...
            if (rocket.landing && rocket.targetVec != null)
            {
                ...
                String warning = LabStuffUtils.translateWithFormat("gui.docking_rocket.warning.name.0", GameSettings.getKeyDisplayString(KeyHandlerClient.spaceKey.getKeyCode()));
                String warning2 = LabStuffUtils.translateWithFormat("gui.docking_rocket.warning.name.1", GameSettings.getKeyDisplayString(KeyHandlerClient.leftShiftKey.getKeyCode()));
                ...
                String targetMotionYStr = LabStuffUtils.translate("gui.docking_rocket.target_vel.name") + ": " + String.valueOf(targetMotionY);
                String currentMotionYStr = LabStuffUtils.translate("gui.docking_rocket.current_vel.name") + ": " + String.valueOf(currentMotionY);
                ...
                OverlayDockingRocket.minecraft.fontRendererObj.drawString(LabStuffUtils.translate("gui.docking_rocket.distance_from.name"), 50, height / 3 + 15, grey);
