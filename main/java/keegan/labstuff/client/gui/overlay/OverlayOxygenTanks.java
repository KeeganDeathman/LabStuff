...
{
    private final static ResourceLocation guiTexture = new ResourceLocation("labstuff:textures/gui/gui.png");
    ...
    {
        final ScaledResolution scaledresolution = LabStuffUtils.getScaledRes(OverlayOxygenTanks.minecraft, OverlayOxygenTanks.minecraft.displayWidth, OverlayOxygenTanks.minecraft.displayHeight);
        ...
        if (invalid)
        {
            String value = LabStuffUtils.translate("gui.warning.invalid_thermal");
