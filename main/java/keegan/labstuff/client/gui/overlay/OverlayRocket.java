...
public class OverlayRocket extends Overlay
{
    ...
    public static void renderSpaceshipOverlay(ResourceLocation guiTexture)
    {
        ...
        final ScaledResolution scaledresolution = LabStuffUtils.getScaledRes(OverlayRocket.minecraft, OverlayRocket.minecraft.displayWidth, OverlayRocket.minecraft.displayHeight);
