...
{
	private ReactionChamber tile;
	private EntityPlayer player;
	private ResourceLocation Tex = new ResourceLocation("labstuff:textures/gui/reactionChamber.png");


	public GuiReactionChamber(InventoryPlayer inventory, ReactionChamber tileEntity)
	{
		super(new ContainerReactionChamber(inventory, tileEntity));
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	{
		...
		{
			displayGauge(34, 121, tile.getScaledFluidLevel(0,100), tile.getTankInfo(null)[0].fluid);
		}
		if(tile.getTankInfo(null)[1].fluid != null)
		{
			displayGauge(16, 121, tile.getScaledFluidLevel(1,100), tile.getTankInfo(null)[1].fluid);
		}
		if(tile.getTankInfo(null)[2].fluid != null)
		{
			displayGauge(206, 121, tile.getScaledFluidLevel(2,100), tile.getTankInfo(null)[2].fluid);
		}
		if(tile.getTankInfo(null)[3].fluid != null)
		{
			displayGauge(224, 121, tile.getScaledFluidLevel(3,100), tile.getTankInfo(null)[3].fluid);
		}
	}
