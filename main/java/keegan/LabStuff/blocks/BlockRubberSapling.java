...
public class BlockRubberSapling extends BlockBush implements IGrowable
{
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = p_149878_5_.nextInt(10) == 0 ? new WorldGenBigTree(true) : new WorldGenTree(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
        ...
        switch (l)
        {
            ...
            case 3:
                ...
                if (!flag)
                {
                    j1 = 0;
                    i1 = 0;
                    object = new WorldGenTree(true, 4 + p_149878_5_.nextInt(7), 3, 3, false);
                }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
            field_149881_b[i] = p_149651_1_.registerIcon("labstuff:sapling_rubber");
        }
    }
