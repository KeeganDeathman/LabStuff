...
public class ItemRenderElectrifier implements IItemRenderer
{
	protected ModelElectrifier electrifierModel;
	protected ResourceLocation Tex;
	
	
	public ItemRenderElectrifier()
	{
		electrifierModel = new ModelElectrifier();
		Tex = new ResourceLocation("labstuff:textures/models/Electrifier.png");
	}
