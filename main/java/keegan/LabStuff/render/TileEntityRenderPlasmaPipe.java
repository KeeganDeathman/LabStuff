...
public class TileEntityRenderPlasmaPipe extends TileEntitySpecialRenderer{
	...
	public void renderPipe(TileEntityPlasmaPipe entity, double x, double y, double z, float tick)
	{
	 ...
	 {
		 if(world.getTileEntity(new BlockPos(x, y, z)) instanceof TileEntityPlasma || world.getTileEntity(new BlockPos(x, y, z)) instanceof TileEntityPlasmaPipe)
			 return true;
		 return false;
	 }
