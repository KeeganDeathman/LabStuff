...
public class ItemRenderWindTurbine implements IItemRenderer
{
	protected ModelWindTurbine electrifierModel;
	protected ResourceLocation Tex;
	
	
	public ItemRenderWindTurbine()
	{
		electrifierModel = new ModelWindTurbine();
		Tex = new ResourceLocation("labstuff:textures/models/WindTurbine.png");
	}
	...
	private void renderEquipped(boolean inventory, ItemRenderType type,  Object... data)
    {
        ...
        if(inventory)
        {
        	...
        	electrifierModel.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.03125F);
        }
        else if(!inventory)
        {
    		Minecraft.getMinecraft().renderEngine.bindTexture(Tex);
        	electrifierModel.render((Entity) data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.03125F);
        }
