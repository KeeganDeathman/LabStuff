...
public class ItemRenderElectronGrabber implements IItemRenderer {

	protected ModelElectronGrabber grabberModel;
	protected ResourceLocation Tex;
	
	
	public ItemRenderElectronGrabber()
	{
		grabberModel = new ModelElectronGrabber();
		Tex = new ResourceLocation("labstuff:textures/models/electron grabber.png");
	}
