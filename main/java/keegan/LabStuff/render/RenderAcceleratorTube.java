...
public class RenderAcceleratorTube extends TileEntitySpecialRenderer{

	public static Minecraft mc = Minecraft.getMinecraft();
	public static ModelPlasmaPipe model = new ModelPlasmaPipe();
	public static ResourceLocation tex = new ResourceLocation("labstuff:textures/models/acceleratorTube.png");
	...
	public void renderPipe(TileEntityAcceleratorTube entity, double x, double y, double z, float tick)
	{
	 ...
	 {
		 if(world.getTileEntity(new BlockPos(x, y, z)) instanceof TileEntityAcceleratorTube || world.getTileEntity(new BlockPos(x, y, z)) instanceof TileEntityAcceleratorDetectorCore)
			 return true;
		 return false;
	 }
