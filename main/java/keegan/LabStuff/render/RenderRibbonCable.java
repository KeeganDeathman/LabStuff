...
public class RenderRibbonCable extends TileEntitySpecialRenderer{

	public static Minecraft mc = Minecraft.getMinecraft();
	public static ModelPlasmaPipe model = new ModelPlasmaPipe();
	public static ResourceLocation tex = new ResourceLocation("labstuff:textures/models/dscribboncable.png");
	...
	public void renderPipe(TileEntityRibbonCable entity, double x, double y, double z, float tick)
	{
	 ...
	 {
		 if(world.getTileEntity(new BlockPos(x, y, z)) instanceof TileEntityRibbonCable || world.getTileEntity(new BlockPos(x, y, z)) instanceof DSCPart)
			 return true;
		 return false;
	 }
