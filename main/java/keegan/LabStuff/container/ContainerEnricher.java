...
public class ContainerEnricher extends Container
{
	...
	public ContainerEnricher(InventoryPlayer inv, TileEntityEnricher tile)
	{
		this.tile = tile;
		...
		this.addSlotToContainer(new Slot(tile, 0, 106, 205));
		this.addSlotToContainer(new Slot(tile, 1, 123, 205));
